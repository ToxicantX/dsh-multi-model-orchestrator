...
test('package declares bundle and client integration exports', () => {
  ...
  assert.equal(packageJson.peerDependencies['@deepseek-ai/dsh-system-prompt'], '^0.1.5-rc.2')
  assert.equal(packageJson.peerDependencies['@deepseek-ai/dsh-tool-subagent'], '^0.1.5-rc.2')
  assert.equal(packageJson.devDependencies['@deepseek-ai/dsh-system-prompt'], '0.1.5-rc.2')
  assert.equal(packageJson.devDependencies['@deepseek-ai/dsh-tool-subagent'], '0.1.5-rc.2')
  assert.equal(packageJson.devDependencies['@deepseek-ai/dsh'], '0.1.5-rc.2')
