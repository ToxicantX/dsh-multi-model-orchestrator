...
const AGENT_WARNING_THRESHOLD = 8;
...
function agentCountWarning(count) {
...
function SettingsOrchestratorSection({ api, t }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			agentCountWarning(agents.length) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				role: "status",
				children: t("agentCountWarning")
			}),
...
const LEGACY_PRESET_DESCRIPTION = "Compatibility alias for sessions created with the legacy orchestrator preset ID.";
		...
		return {
			...
			result: {
				...
				value: {
					...
					presets: response.result.value.presets.filter((preset) => !(preset.id === LEGACY_PRESET_ID && preset.description === LEGACY_PRESET_DESCRIPTION))
				}
			}
		};
	};
